...
LIB_DIY=$(SIM_ROOT)/diy_lib/libdiy.a
SIM_TARGETS=$(LIB_DIY) $(LIB_DECODER) $(LIB_CARBON) $(LIB_SIFT) $(LIB_PIN_SIM) $(LIB_FOLLOW) $(STANDALONE) $(PIN_FRONTEND) $(DYNAMORIO_FRONTEND)
...
$(LIB_DIY):
	@$(MAKE) $(MAKE_QUIET) -C $(SIM_ROOT)/diy_lib

$(LIB_CARBON): $(LIB_DIY)
	@$(MAKE) $(MAKE_QUIET) -C $(SIM_ROOT)/common

$(LIB_SIFT): $(LIB_CARBON) $(LIB_DIY)
	@$(MAKE) $(MAKE_QUIET) -C $(SIM_ROOT)/sift

$(LIB_DECODER): $(LIB_CARBON) $(LIB_DIY)
